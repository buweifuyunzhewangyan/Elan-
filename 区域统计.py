...
oslist = os.listdir('C://Users//Elane053//Desktop//lys实习工作//2017年数据//20190103132413_区域2数据2017年')
all_shipmmsi=[]
all_huochuan = []
all_yuchuan = []
for one_os in tqdm(oslist[0:60]):
    a = one_os
    b = a[15:]+'_'
    f=open('C://Users//Elane053//Desktop//lys实习工作//2017年数据//20190103132413_区域2数据2017年//'+a)
    df1 = pd.read_csv(f)
...
all_shipmmsi = list(set(all_shipmmsi))
all_huochuan = list(set(all_huochuan))
all_yuchuan = list(set(all_yuchuan))
print('总船舶数：',len(all_shipmmsi))
print('货船总数：',len(all_huochuan))
print('渔船总数：',len(all_yuchuan))